...
source(here("r", "create_s1_measures_table.R"))
source(here::here("r", "upsert_rds.R"))
...
## Get the table of measures used for Study 1
s1_measures_dfs <- create_s1_measures_table()
```
...
upsert_rds(s1a_target_vars, here("data_public/subset", "Study1a_public_target.rds"))
